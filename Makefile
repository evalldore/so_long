...
SRCS	:= main.c entities.c so_long.c controls.c movement.c assets.c sprites.c \
		components/controls.c components/position.c components/gravity.c components/velocity.c components/sprite.c
