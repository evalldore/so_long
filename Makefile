...
SRCS	:= main.c utils.c collectible.c ai.c projectiles.c interaction.c vector.c box.c gravity.c coordinates.c collision.c parsing.c map.c map_utils.c entities.c so_long.c controls.c movement.c assets.c sprites.c animation.c state.c\
